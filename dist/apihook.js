...
var apihook = exports.apihook = function apihook() {
  ...
  var callApi = (0, _react.useCallback)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var overrideConfig,
      response,
      _args = arguments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          overrideConfig = _args.length > 0 && _args[0] !== undefined ? _args[0] : config;
          setLoading(true);
          setError(null);
          setSuccess(false);
          _context.prev = 4;
          _context.next = 7;
          return (0, _axios["default"])(overrideConfig);
        case 7:
